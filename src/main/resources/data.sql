-- Insert role data first
INSERT INTO role (role_id, role) VALUES (1, 'ROLE_ADMIN'), (2, 'ROLE_USER'), (3, 'ROLE_MANAGER'), (4, 'ROLE_OWNER');

-- Insert users with foreign key reference to role
INSERT INTO users (id, email, enabled, first_name, last_name, password, username, role_id)
...
-- Insert customer data with String phone numbers
INSERT INTO customer (id, address, city, email, enabled, first_name, last_name, name, phone)
VALUES ('1', 'Small Street', 'Smallville', 'smallmail@mail.com', '1', 'SmallFN', 'SmallLN', 'Small INC', '1234567890'),
  ('2', 'Medium Street', 'Midtown', 'midmail@mail.com', '1', 'MidFN', 'MidLN', 'Mid INC', '4567890123'),
  ('3', 'Big Street', 'Big City', 'bigmail@mail.com', '1', 'BigFN', 'BigLN', 'Big INC', '7890123456');

-- Insert customer_category mapping
INSERT INTO customer_category (customer_id, category_id)
VALUES (1, 1), (2, 2), (3, 3);

-- Insert contract data with proper date format
